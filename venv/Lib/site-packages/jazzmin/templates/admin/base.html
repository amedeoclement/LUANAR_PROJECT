    ...
    {% if not is_popup %}
        <nav class="main-header navbar navbar-expand {{ jazzmin_ui.navbar_classes }}" id="jazzy-navbar">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <span class=" text-capitalize" style="color:green; font-size: larger; font-family: 'Times New Roman', Times, serif;">{{ request.user  }}</span>
             
                {% else %}
               
                <span class=" text-capitalize" style="color:green; font-size: larger; font-family: 'Times New Roman', Times, serif;">{{ request.user.first_name  }}&nbsp; {{ request.user.last_name  }}</span>
                {% endif %}
                &nbsp; &nbsp;
                <li class="nav-item dropdown">
                   
                    <a class =" "data-toggle="dropdown"> <i class="far fa-user" aria-hidden="true"></i></a>
        ...
        {% if jazzmin_settings.show_sidebar %}
            ...
            <aside class="main-sidebar elevation-4 {{ jazzmin_ui.sidebar_classes }}" id="jazzy-sidebar">
                <a href="{% url 'admin:index' %}" class="brand-link {{ jazzmin_ui.brand_classes }}" id="jazzy-logo">
                     <span class="brand-text " style="font-weight:bolder; color: rgb(39, 236, 39); text-align: center;">{{ jazzmin_settings.site_brand }}</span>
                </a>
