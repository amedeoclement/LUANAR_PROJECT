...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{% url opts|admin_urlname:'change' object.pk|admin_urlquote %}">{{ object|truncatewords:"4" }}</a></li>
                          ...
                          <div>
                            <i class="fas fa-clock bg-gray"></i>
                              {% if not action_list %}
                                <div class="timeline-item">
                                    <h3 class="timeline-header no-border ">
                                        {% trans "This object doesn't have a change history. It probably wasn't added via this admin site. Please trace this object!!" %}
                                    </h3>
                                </div>
                              {% endif %}
                          </div>
